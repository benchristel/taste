var __defProp=Object.defineProperty;var __name=(target,value)=>__defProp(target,"name",{value,configurable:!0});__name(function(){const relList=document.createElement("link").relList;if(relList&&relList.supports&&relList.supports("modulepreload"))return;for(const link of document.querySelectorAll('link[rel="modulepreload"]'))processPreload(link);new MutationObserver(mutations=>{for(const mutation of mutations)if(mutation.type==="childList")for(const node of mutation.addedNodes)node.tagName==="LINK"&&node.rel==="modulepreload"&&processPreload(node)}).observe(document,{childList:!0,subtree:!0});function getFetchOpts(link){const fetchOpts={};return link.integrity&&(fetchOpts.integrity=link.integrity),link.referrerPolicy&&(fetchOpts.referrerPolicy=link.referrerPolicy),link.crossOrigin==="use-credentials"?fetchOpts.credentials="include":link.crossOrigin==="anonymous"?fetchOpts.credentials="omit":fetchOpts.credentials="same-origin",fetchOpts}__name(getFetchOpts,"getFetchOpts");function processPreload(link){if(link.ep)return;link.ep=!0;const fetchOpts=getFetchOpts(link);fetch(link.href,fetchOpts)}__name(processPreload,"processPreload")},"polyfill")();const $boundArguments=Symbol(),$equals=Symbol(),$getBoundArguments=Symbol(),$unapplied=Symbol();function curry$2(f){switch(f.length){case 2:return curry2$1(f);case 3:return curry3$1(f);default:return curryVarargs$1(f)}}__name(curry$2,"curry$2");function curry2$1(f){function curried(a,b){switch(arguments.length){case 1:return copyMetadata$1(curried,[a],f.bind(null,a));default:return f(a,b)}}return __name(curried,"curried"),initMetadata$1(f,curried)}__name(curry2$1,"curry2$1");function curry3$1(f){function curried(a,b,c){switch(arguments.length){case 1:return copyMetadata$1(curried,[a],curry2$1(f.bind(null,a)));case 2:return copyMetadata$1(curried,[a,b],f.bind(null,a,b));default:return f(a,b,c)}}return __name(curried,"curried"),initMetadata$1(f,curried)}__name(curry3$1,"curry3$1");function curryVarargs$1(f){function curried(...args){return args.length<f.length?copyMetadata$1(curried,args,curried.bind(null,...args)):f(...args)}return __name(curried,"curried"),initMetadata$1(f,curried)}__name(curryVarargs$1,"curryVarargs$1");function initMetadata$1(original,curried){return curried.displayName=getName$1(original),curried[$getBoundArguments]=()=>[],curried[$unapplied]=curried,curried}__name(initMetadata$1,"initMetadata$1");function copyMetadata$1(source,args,destination){return destination.displayName=getName$1(source),destination[$getBoundArguments]=()=>getArgs$1(source).concat(args),destination[$unapplied]=source[$unapplied],destination}__name(copyMetadata$1,"copyMetadata$1");function getName$1(f){return f.displayName??f.name}__name(getName$1,"getName$1");function getArgs$1(f){return f[$getBoundArguments]()??[]}__name(getArgs$1,"getArgs$1");function curry$1(f,name){const curried=curry$2(f);return curried.displayName=name||functionName(f),curried}__name(curry$1,"curry$1");function partialArgs(f){return f[$getBoundArguments]?.()??[]}__name(partialArgs,"partialArgs");function functionName(f){return f.displayName||f.name}__name(functionName,"functionName");function lastOf(a){return a[a.length-1]}__name(lastOf,"lastOf");function firstOf(a){return a[0]}__name(firstOf,"firstOf");function curry(f){switch(f.length){case 2:return curry2(f);case 3:return curry3(f);default:return curryVarargs(f)}}__name(curry,"curry");function curry2(f){function curried(a,b){switch(arguments.length){case 1:return copyMetadata(curried,[a],f.bind(null,a));default:return f(a,b)}}return __name(curried,"curried"),initMetadata(f,curried)}__name(curry2,"curry2");function curry3(f){function curried(a,b,c){switch(arguments.length){case 1:return copyMetadata(curried,[a],curry2(f.bind(null,a)));case 2:return copyMetadata(curried,[a,b],f.bind(null,a,b));default:return f(a,b,c)}}return __name(curried,"curried"),initMetadata(f,curried)}__name(curry3,"curry3");function curryVarargs(f){function curried(...args){return args.length<f.length?copyMetadata(curried,args,curried.bind(null,...args)):f(...args)}return __name(curried,"curried"),initMetadata(f,curried)}__name(curryVarargs,"curryVarargs");function initMetadata(original,curried){return curried.displayName=getName(original),curried[$getBoundArguments]=()=>[],curried[$unapplied]=curried,curried}__name(initMetadata,"initMetadata");function copyMetadata(source,args,destination){return destination.displayName=getName(source),destination[$getBoundArguments]=()=>getArgs(source).concat(args),destination[$unapplied]=source[$unapplied],destination}__name(copyMetadata,"copyMetadata");function getName(f){return f.displayName??f.name}__name(getName,"getName");function getArgs(f){return f[$getBoundArguments]()??[]}__name(getArgs,"getArgs");const equalsWith=curry(_equalsWith);function _equalsWith(options,a,b){const override=options.override?.(a,b);if(override!==void 0)return override;if(a==null||b==null)return a===b;if(typeof a[$equals]=="function")return!!a[$equals](b);if(Object.is(a,b))return!0;if(typeof a=="function"&&typeof b=="function"){const aUnapplied=a[$unapplied],bUnapplied=b[$unapplied];return aUnapplied!=null&&aUnapplied===bUnapplied&&_equalsWith(options,getBoundArguments$1(a),getBoundArguments$1(b))}if(typeof a!="object")return!1;const aConstructorString=functionString(constructorOf(a)),bConstructorString=functionString(constructorOf(b));if(aConstructorString!==bConstructorString)return!1;if(dateConstructorString===aConstructorString)return Object.is(+a,+b);if(regexConstructorString===aConstructorString)return String(a)===String(b);if(a instanceof Error||nativeErrorConstructorStrings.includes(aConstructorString))return a.message===b.message;if(Array.isArray(a))return a.length===b.length&&a.every((_,i)=>_equalsWith(options,a[i],b[i]));if(setConstructorString===aConstructorString)return a.size===b.size&&[...a].every(v=>b.has(v));if(mapConstructorString===aConstructorString){if(a.size!==b.size)return!1;for(const key of a.keys())if(!b.has(key)||!_equalsWith(options,a.get(key),b.get(key)))return!1;return!0}if(objectConstructorString===aConstructorString||protoOf(a)===protoOf(b)){const aKeys=Object.keys(a),bKeys=Object.keys(b);if(aKeys.length!==bKeys.length)return!1;const bKeySet=new Set(bKeys);for(const key of aKeys)if(!bKeySet.has(key)||!_equalsWith(options,a[key],b[key]))return!1;return!0}return!1}__name(_equalsWith,"_equalsWith");equalsWith({});function getBoundArguments$1(f){return f[$getBoundArguments]?.()??f[$boundArguments]}__name(getBoundArguments$1,"getBoundArguments$1");function functionString(f){return typeof f!="function"?"":Function.prototype.toString.call(f)}__name(functionString,"functionString");function constructorOf(value){return protoOf(value)?.constructor}__name(constructorOf,"constructorOf");const protoOf=Object.getPrototypeOf,objectConstructorString=functionString(Object),dateConstructorString=functionString(Date),regexConstructorString=functionString(RegExp),setConstructorString=functionString(Set),mapConstructorString=functionString(Map),nativeErrorConstructorStrings=[functionString(Error),functionString(EvalError),functionString(RangeError),functionString(ReferenceError),functionString(SyntaxError),functionString(TypeError),functionString(URIError)];function getBoundArguments(f){return f[$getBoundArguments]?.()??[]}__name(getBoundArguments,"getBoundArguments");const which=curry$1(function(predicate,x){return predicate(x)},"which"),equals=equalsWith({override(a,b){if(typeof a=="function"&&a[$unapplied]===which)return getBoundArguments(a).length===1&&a(b)}});equals.displayName="equals";equals[$getBoundArguments]=()=>[];const is$2=curry$1(function(a,b){return a===b},"is"),not=curry$1(function(predicate,subject,...args){return!predicate(subject,...args)},"not"),isBlank=curry$1(function(s){return/^\s*$/.test(s)},"isBlank");function prettyFunctionName(f){return functionName(f)||"<function>"}__name(prettyFunctionName,"prettyFunctionName");function pretty(x){const stack=[];return _pretty(x);function _pretty(x2){if(x2===null)return"null";if(typeof x2=="function")return preventInfiniteLoop(x2,prettyFunction);if(typeof x2=="string")return quote(x2);if(typeof x2=="bigint")return`${x2}n`;if(Array.isArray(x2))return preventInfiniteLoop(x2,prettyArray);if(x2 instanceof Date)return`Date(${x2.toISOString().replace("T"," ").replace("Z"," UTC")})`;if(x2 instanceof RegExp)return String(x2);if(x2 instanceof Error)return`${prettyConstructor(x2)}(${quote(x2.message)})`;if(x2 instanceof Set)return preventInfiniteLoop(x2,prettySet);if(typeof x2=="object"){const constructor=x2?.__proto__?.constructor;return constructor===Object||!constructor?preventInfiniteLoop(x2,prettyObject):`${prettyConstructor(x2)} ${preventInfiniteLoop(x2,prettyObject)}`}return String(x2)}function preventInfiniteLoop(x2,cb){if(stack.indexOf(x2)>-1)return"<circular reference>";stack.push(x2);const result=cb(x2);return stack.pop(),result}function prettyFunction(f){const args=partialArgs(f).map(_pretty),name=prettyFunctionName(f);return args.length?formatStructure(name+"(",args,",",")"):name}function prettyArray(a){return formatStructure("[",a.map(_pretty),",","]")}function prettyObject(x2){const innards=Object.entries(x2).map(([k,v])=>`${prettyKey(k)}: ${_pretty(v)}`);return formatStructure("{",innards,",","}")}function prettySet(x2){const innards=[...x2.values()].map(_pretty);return formatStructure("Set {",innards,",","}")}}__name(pretty,"pretty");function prettyKey(k){return/^[a-zA-Z0-9_$]+$/.test(k)?k:quote(k)}__name(prettyKey,"prettyKey");function prettyConstructor(obj){return prettyFunctionName(obj.__proto__.constructor)}__name(prettyConstructor,"prettyConstructor");function quote(s){return'"'+String(s).replace(/\\/g,"\\\\").replace(/\n/g,"\\n").replace(/\t/g,"\\t").replace(/"/g,'\\"').replace(/[\x00-\x1f\x7f]/g,hexEscape)+'"'}__name(quote,"quote");function hexEscape(c){const hex=c.charCodeAt(0).toString(16);return"\\x"+(hex.length<2?"0"+hex:hex)}__name(hexEscape,"hexEscape");function indent(level,s){return s.split(`
`).map(l=>l&&prepend(repeat(level," "))(l)).join(`
`)}__name(indent,"indent");function toLines(...strs){return strs.map(append(`
`)).join("")}__name(toLines,"toLines");function repeat(n,s){return Array(n+1).join(s)}__name(repeat,"repeat");const prepend=__name(prefix=>s=>prefix+s,"prepend"),append=__name(suffix=>s=>s+suffix,"append"),removePrefix=curry$1(__name(function(prefix,s){return s.slice(0,prefix.length)===prefix?s.slice(prefix.length):s},"removePrefix"));function lines(s){return String(s).split(/\r?\n/)}__name(lines,"lines");function trimMargin(s){const lns=lines(s);isBlank(firstOf(lns))&&lns.shift(),isBlank(lastOf(lns))&&lns.pop();const initialIndent=/^[ \t]*/.exec(firstOf(lns))[0];return lns.map(removePrefix(initialIndent)).join(`
...
`),is$2,'"\\n\\n"')},"escapes quotes"(){expect(pretty('""'),is$2,'"\\"\\""')},"puts slashes around regexen"(){expect(pretty(/[a-z]+/),is$2,"/[a-z]+/")},"escapes literal slashes in regexen"(){expect(pretty(/http:\/\//),is$2,"/http:\\/\\//")},"represents an empty array as []"(){expect(pretty([]),is$2,"[]")},"formats an array with one element inline"(){expect(pretty(["a"]),is$2,'["a"]')},"formats an array with two elements"(){expect(pretty(["a","b"]),is$2,trimMargin`
    ...
    `)},"avoids infinite recursion in arrays"(){const a=[],b=[a];a.push(b),expect(pretty(a),is$2,"[[<circular reference>]]")},"avoids infinite recursion in function args"(){const a=[],f=curry$1(__name(function(a2,b){},"f"));a.push(f(a)),expect(pretty(a),is$2,"[f(<circular reference>)]")},"avoids infinite recursion in POJOs"(){const obj={};obj.foo=obj,expect(pretty(obj),is$2,"{foo: <circular reference>}")},"avoids infinite recursion in instances of classes"(){class MyClass{static{__name(this,"MyClass")}}const obj=new MyClass;obj.foo=obj,expect(pretty(obj),is$2,"MyClass {foo: MyClass <circular reference>}")},"avoids infinite recursion in sets"(){const set=new Set;set.add(set),expect(pretty(set),is$2,"Set {<circular reference>}")},"formats a template string"(){expect(pretty("1"),is$2,'"1"')},"represents an anonymous function as <function>"(){expect(pretty(()=>{}),is$2,"<function>")},"formats a function name"(){expect(pretty(pretty),is$2,"pretty")},"prints the name of a curried function"(){expect(pretty(is$2),is$2,"is")},"prints partial arguments passed to a function"(){const foo=curry$1(__name(function(a,b,c){},"foo"));expect(pretty(foo(1)),is$2,"foo(1)"),expect(pretty(foo(1)(2)),is$2,trimMargin`
      foo(
        1,
        2
      )
    ...
    `)},"prints partial arguments passed to Taste's `equals`"(){expect(pretty(equals(1)),is$2,"equals(1)")},"pretty-formats function arguments"(){const foo=curry$1(__name(function(a,b,c){},"foo"));expect(pretty(foo("hi")),is$2,'foo("hi")')}});test("toLines",{"returns empty string given no args"(){expect(toLines(),is$2,"")},"returns a single line"(){expect(toLines("foo"),is$2,`foo
